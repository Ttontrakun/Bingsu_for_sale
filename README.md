...
ผลลัพธ์: `Bingsu_core/backups/<timestamp>/` (Postgres dump + Qdrant snapshot)
...
คู่มือผู้ดูแล: [`Bingsu_core/คู่มือใช้งาน-Supportadmin.docx`](Bingsu_core/คู่มือใช้งาน-Supportadmin.docx)
