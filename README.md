...
ตั้งใน `Bingsu_core/Backend/.env`
...
ผลลัพธ์อยู่ที่ `Bingsu_core/backups/<timestamp>/` (Postgres dump + Qdrant snapshot)
...
> คู่มือผู้ดูแล: `Bingsu_core/คู่มือใช้งาน-Supportadmin.docx`
...
**ตรวจเหตุการณ์ในแอป:** Supportadmin → **Logs** (ล็อกอินผิด, แก้ user/บอท/Knowledge ฯลฯ)  
